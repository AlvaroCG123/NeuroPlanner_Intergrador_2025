  ...
  const handleClick = () => {
   ...
   return (
      <div className="min-h-screen w-full font-sans flex flex-col bg-[#182132] items-center justify-center lg:justify-center py-4 lg:py-0 px-4 lg:px-0">
        <section className='flex flex-col gap-8 lg:gap-20 md:bg-[#202D40] bg-transparent rounded-3xl lg:rounded-4xl p-6 lg:px-39 lg:pt-5 lg:pb-20 max-w-4xl lg:max-w-337 lg:h-200'>
          <p className='text-[#6E8FCE] text-lg lg:text-2xl'>3/6</p>
          <div className='flex flex-col gap-8 lg:gap-10'>
            <p className='text-[white] text-2xl lg:text-4xl text-start lg:text-center'>Qual é o seu principal objetivo acadêmico para este intercâmbio?</p>
            ...
            <button className='text-[white] bg-[#273346] p-4 lg:p-4.5 rounded-2xl lg:rounded-3xl text-base lg:text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
              Apenas passar nas matérias, sem grandes expectativas.
            </button>
  
            <button className='text-[white] bg-[#273346] p-4 lg:p-4.5 rounded-2xl lg:rounded-3xl text-base lg:text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
              Atingir bom desempenho em todas as disciplinas, com tempo para lazer.
            </button>
  
            <button className='text-[white] bg-[#273346] p-4 lg:p-4.5 rounded-2xl lg:rounded-3xl text-base lg:text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
              Dominar o novo idioma e fazer muitos amigos.
            </button>
            ...
            <div>
              ...
              <div className='flex gap-9'>
                  ...
                  <Link to="/Formulario4"><button className="text-[white] bg-[#182132] hover:bg-[#2e64c2] rounded-3xl px-6 py-1.5 text-xl cursor-pointer">
                     Avançar
                  </button>
                  </Link>
                </div>
