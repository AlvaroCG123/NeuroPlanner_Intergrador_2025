...
export default function Formulario2() {
  ...
  return (
    ...
    <section className='flex flex-col gap-10 bg-[#202D40] rounded-4xl px-39 pt-5 pb-20'>
      <p className='text-[#6E8FCE] text-2xl'>2/6</p>
      <div className='flex flex-col gap-10'>
        <p className='text-[white] text-4xl text-center'>Em relação à duração e estrutura, <br />como você prefere organizar suas sessões de estudo?</p>
        ...
        <button className='text-[white] bg-[#273346] p-4.5 rounded-3xl text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
          <p>Estudar quando me sinto inspirado, sem rotina fixa.</p></button>

        <button className='text-[white] bg-[#273346] p-4.5 rounded-3xl text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
          <p>Blocos de estudo longos (1-2 horas) com poucas poucas pausas.</p></button>

        <button className='text-[white] bg-[#273346] p-4.5 rounded-3xl text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
          <p>Varia muito, depende da matéria e do meu humor.</p></button>

        <button className='text-[white] bg-[#273346] p-4.5 rounded-3xl text-2xl text-left hover:bg-[#17263f] focus:bg-[#17263f] cursor-pointer'>
          <p>Blocos de estudo curtos (25-30 minutos) com intervalos frequentes (5-10 minutos).</p></button>
