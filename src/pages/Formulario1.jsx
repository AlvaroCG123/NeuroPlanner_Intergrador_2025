...
export default function Formulario1() {
  ...
  return (
    <div className="min-h-screen w-full font-sans flex flex-col bg-[#182132] items-center justify-center lg:justify-center py-4 lg:py-0 px-4 lg:px-0">
      <section className='flex flex-col gap-8 lg:gap-20 md:bg-[#202D40] bg-transparent rounded-3xl lg:rounded-4xl p-6 lg:px-39 lg:pt-5 lg:pb-20 max-w-4xl lg:max-w-none lg:h-200'>
        <p className='text-[#6E8FCE] text-lg lg:text-2xl'>1/6</p>
        <div className='flex flex-col gap-8 lg:gap-10'>
          ...
          <div>
            <div className="flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-0">
              ...
              <Link to="/Formulario2"><button className="text-[white] bg-[#182132] hover:bg-[#2e64c2] rounded-3xl px-6 py-1.5 text-xl cursor-pointer">
                     Avançar
                  </button>
                  </Link>
            </div>
